...
|---|---|---|---|---|
| A-W5-1 | External counsel can deliver enforceable Master Owner Lease, Renter ToS, regulatory-posture memos, payments/MSB analysis, privacy/state-privacy, tax/sales-tax nexus, insurance coverage review, registrar/ICANN, reserve architecture/bankruptcy-remoteness, and sale-proceeds escrow mechanism within revised pre-launch budget ($22–45k itemized; $50k budgeted with contingency, per W5 §9.13). | **launch-blocking — open** | W5 §9.13 itemized; supersedes v0 $15–35k. Required before code build. Counsel quote required to confirm. | W5 / W7 |
| A-W5-2 | The Rev-1 sale-escape clause (anti-avoidance triggers, 12-month seasoning, greatest-of exit fee, sale-proceeds escrow, UCC-1-style mechanism) is enforceable in Delaware governing law against third-party purchasers and successors-in-interest. | **launch-blocking — open** | W5 §9.3. External counsel sign-off required pre-launch (LB-W5-1, LB-W5-9). Coupled to K-W5-1. Supersedes v0 weaker formulation. | W5 |
| A-W5-3 | Cyber Liability + Tech E&O insurance is available to a marketplace of our profile at the revised premium estimate ($6–12k/yr, $1M aggregate, $25k deductible), with coverage that does not exclude email-abuse / spam / phishing / customer-intentional-acts in a way that nullifies the indemnification model. | **launch-blocking — open** | W5 §9.4. Broker quote + counsel coverage-summary review required (LB-W5-4). Coupled to K-W5-5. Supersedes v0 $4.5–8k estimate. | W5 / W7 |
| A-W5-4 | Stripe Connect Custom + the Rev-1 reserve architecture (per §9.6: rolling reserve in Stripe balance, migration reserve in segregated FBO bank account, indemnification reserve as accrued liability) keeps the platform outside money-transmitter classification in all 50 US states. | **launch-blocking — open** | W5 §9.6 + §9.10 (US-only). Counsel memo + Stripe written confirmation required (LB-W5-7, LB-W5-8). | W5 |
| A-W5-5 | Owner death/incapacity rate among the Dormant + Resigned cohort is ≤ 2% / year; succession-clause invocation rate is therefore manageable at 1–4 invocations/year at 50-domain steady state. | open | W5 §1.1 mode 5 + §9.7. Measurable only with live cohort; relies on actuarial priors until then. | W5 / W6 |
...
| A-W5-7 | ≤ 30% sale-escapable inventory cap (with K-W5-3a auto-tightening to 20% on first rug-pull within 12 months) is sufficient to keep aggregate sale-escape invocation impact below renter-trust collapse threshold. | open | W5 §Executive Summary + §9.3 + §9.11. Coupled to K-W5-1, K-W5-3a, K-W5-4. Y2 measurement after sale-escape inventory exists. | W5 / W2 |
| A-W5-8 | Selected registrar partner(s) (candidates: Cloudflare Registrar, Porkbun, Hover) support either dual-control account delegation OR registry-lock + transfer-lock + auto-renew confirmation in a way that survives owner non-cooperation, per §9.1 Bonded Premium and Standard tier requirements. | **launch-blocking — open** (NEW Rev-1) | W5 §9.1 + LB-W5-7. Written confirmation from registrar required pre-launch. Without this, neither tier can launch. | W5 / Engineering |
| A-W5-9 | The W7 reserve EV-loss model will conclude that Rev-1's reserve structure is fundable within Rev-2 §2i + a discrete pre-launch capital line (insurance binder + counsel + W5 reserves) without breaking Rev-2's $245k central capital plan beyond a planning tolerance (e.g., +20%). | **launch-blocking — open** (NEW Rev-1) | W5 §9.2 + LB-W5-10. v0 reserve numerics ($24k migration, $50k indemnification, $74–82k aggregate) are PLACEHOLDER pending W7. If W7 model concludes the Rev-2 plan is broken, that is a W7 go/no-go input. | W5 / W7 |

---

*Last updated: W5 Continuity Rev-1 (2026-04-27) — A-W5-1 through A-W5-4 revised to reflect §9 amendments (broader counsel scope, Rev-1 sale-escape mechanism, revised insurance estimate, Rev-1 reserve architecture); A-W5-8 added (registrar-partner technical confirmation, launch-blocking, NEW); A-W5-9 added (W7 reserve EV-loss model, launch-blocking, NEW). Five W5 assumptions now launch-blocking. Prior baseline: W5 v0 initial draft (2026-04-27) — added A-W5-1 through A-W5-7. Earlier: W4 Rev-2.2 sending-bridge dependency (2026-04-27) — added A-W4-8. Earlier: W4 Rev-2.1 rubber-duck pass — A-pre-1 downgraded; A-W4-2 scope-clarified; added A-W4-6 (Gate 0) and A-W4-7. Earlier: W4 Rev-2 alignment (2026-04-26) added A-W4-1 through A-W4-5. Earlier baseline: Rev-2 close (2026-05-06). Pricing & namespace: two-tier Premium $25 / Standard $9, 50 renters/domain, blended ARPU $11, capital $245k central. W1 A7 superseded by A-Rev2-3; W2 A-W2-7 tightened via A-Rev2-5; K-W3-1/2/3 revised in `_kill_criteria.md`.*
