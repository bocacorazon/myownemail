...
*Last updated: W4 Rev-2.1 rubber-duck pass (2026-04-27) — K-W4-2 split into K-W4-2a (Tier 1 false-positive rate, UX risk), K-W4-2b (confirmed forwarding-abuse rate), K-W4-2c (send-as complaint rate); K-W4-3 reformulated to observable proxies (chargeback rate, near-duplicate identity, IDV-cohort abuse rate); K-W4-4 added (Gate 0 send-as deliverability proof); K-W4-5 added (Mailgun account-level reputation incidents). Prior baseline: W4 Rev-2 alignment (2026-04-26) — K-W4-1 locked at K-Rev2-3 thresholds; K-W4-2/3 added. Earlier baseline: Rev-2 close (2026-05-06). K-W3-1 revised to $67 PIVOT / $100 KILL; K-W3-2 ratios unchanged but blended LTV input drops to $120; K-W3-3 revised to 25 floor / 40 target per-domain, 50 domains × 2,000 renters marketplace; added K-Rev2-1 through K-Rev2-5.*
