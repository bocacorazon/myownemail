...
> **⚠ Rev-2 banner (2026-05-06).** Pricing architecture and per-domain namespace reopened in `docs/08_pricing_namespace_rev2.md`. Rev-2 adopts a two-tier namespace (**Premium single-name $25/mo + Standard compound $9/mo**) with ~50 renters/domain at liquidity, blended ARPU $11.00 (was $16.50), net platform contribution $3.14/renter-mo (was $6.00), per-domain net contribution $157/mo (was $111), owner payout $2,640/yr (was $1,584), blended LTV $120 (was $220), capital requirement $245k lean-organic central (was $275k). **The following numeric kill criteria in §2f / §2e are superseded by doc 08 §9:** K-W3-1 (new: $67 PIVOT / $100 KILL, was $120 / $180), K-W3-2 (ratios unchanged but LTV input changes to $120), K-W3-3 (new: 40 target / 25 floor per-domain, 50 domains × 2,000 renters marketplace; was 20/12/50/1,000). Unit-economics table (§2a) superseded by doc 08 §3.1. 3-year financial model (§2h) superseded by doc 08 §7. Take-rate 60/40, sale-escape reserve, owner-side LTV analysis, and overall verdict framework are retained. **New Rev-2 kill criteria** K-Rev2-1 through K-Rev2-5 added — see doc 08 §9 and `_kill_criteria.md`. Refer to doc 08 as source of truth for all Rev-2 pricing and capital numbers.
